...
function check(){
	if(!$("#join_user_agree").is(":checked")){
		alert("회원가입 약관에 동의하세요");
		$("#user_agree").css("border", "2px solid red");
		return false;
	}
	if(!$("#join_priv_agree").is(":checked")){
		alert("개인정보 처리 약관에 동의하세요");
		$("#priv_agree").css("border", "2px solid red");
		return false;
	}
	return true;
}
...
function changeCheck(){
	var privAgree = $("#join_priv_agree");
	var userAgree = $("#join_user_agree");
	
	if(privAgree.is(":checked")) $("#user_agree").css("border", "");
	if(userAgree.is(":checked")) $("#priv_agree").css("border", "");
	
	if(privAgree.is(":checked") && userAgree.is(":checked")){
		$("#agreeBtn").addClass("btn-success");
	}else{
...
<body>
	...
	<div class="row">
		...
		<div class="col-sm-offset-2 col-sm-6">
			<form role="form" id="joinForm" method="post" action="${ pageContext.request.contextPath }/member/signUpForm.do" autocomplete="off" onsubmit="return check()">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group pull-left" id="serviceArea">
...
이 약관은 2014년 03월 20일부터 시행합니다.
							...
							<div class="col-xs-12">
								<div class="checkbox pull-right">
									<label for="join_user_agree" id="user_agree">
										<input type="checkbox" name="join_user_agree" id="join_user_agree" value="1" onchange="changeCheck()"/>
										회원가입 약관에 동의합니다.</label>
								</div>
							</div>
						</div>
						<div class="form-group pull-left" id="userArea">
...
회사는 개인정보 수집 및 이용목적이 달성된 후에는 예외 없이 해당 정보를 지체 없이 파기합니다.
							...
							<div class="col-xs-12">
								<div class="checkbox pull-right">
									<label for="join_priv_agree" id="priv_agree">
										<input type="checkbox" name="join_priv_agree" id="join_priv_agree" value="1" onchange="changeCheck()"/>
					...
					<div class="panel-footer">
						<div style="overflow: hidden">
							<div class="col-sm-offset-3 col-sm-6">
								<button class="btn btn-lg btn-block" type="submit" id="agreeBtn">동의</button>
							</div>
						</div>
					</div>
				</div>
