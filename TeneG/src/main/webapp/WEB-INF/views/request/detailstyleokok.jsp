...
<script type="text/javascript">
	...
	function get_status(status) {
		if (status == 'D') {
			...
			document.getElementById("sta").innerHTML = "현재상태: 전문가매칭완료";
		} else if (status == 'P') {
...
<body data-spy="scroll" data-target=".navbar" data-offset="50">
	...
	<div id="sections" class="container-fluid">
		...
		<c:forEach var="file" items="${ fileList }" >
			<div>
				<img src="${ pageContext.request.contextPath }/upload/${file.saveFileName}"  width=610px height=300px />
			</div>
		</c:forEach>
						</div>
					</div>
				...
				<div class="thumbnail">
					...
					<div class="gig-price">
						<div class="caption">
							...
							<button class="btn" onclick="btnClick('S')">
								<span class="glyphicon glyphicon-ok-sign">수락(<i
									class="fa fa-krw"></i>&nbsp;${request.price})
								</span>
								<br />
							</button>
				...
				<div class="thumbnail">
					...
					<div class="caption">
						...
						<button class="btn"  onclick="btnClick()">
							<span class="glyphicon glyphicon-ok-sign">수락하기</span>
						</button>
					</div>
				</div>
			</div>
